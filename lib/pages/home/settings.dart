...
class _SettingsPageState extends State<SettingsPage> {
  bool hideHyperlegibleFontSwitch = true;
  bool hidePreferGreyscaleSwitch = true;
  bool hideHideFingerDrawingToggleSwitch = true;
  bool hideAutoClearWhiteboardOnExitSwitch = true;
  bool hideDisableEraserAfterUseSwitch = true;
  bool hideAutoStraightenLinesSwitch = true;
  bool hideEditorAutoInvertSwitch = true;
  bool hideEditorPromptRenameSwitch = true;
  bool hideHideHomeBackgroundsSwitch = true;
  bool hideRecentColorsDontSavePresetsSwitch = true;
  bool hideRecentColorsLength = false;
  bool hidePrintPageIndicatorsSwitch = true;
  bool hideMaxImageSizeSelection = true;
  bool hideAutosaveDelaySelection = true;
  bool hideShapeRecognitionDelaySelection = true;
  bool hideEditorToolbarShowInFullscreenSwitch = false;
  bool hideEditorToolbarAlignmentSelection = true;
  bool hideAllowInsecureConnectionsSwitch = true;
  bool hideShouldCheckForUpdatesSwitch = true;
  bool hideShouldAlwaysAlertForUpdatesSwitch = true;
  bool hideDisableAdsSwitch = true;
  bool hideChangeAdsConsentButton = true;
  @override
  void initState() {
        ...
        slivers: [
          ...
          SliverSafeArea(
            ...
            children: [
              ...
              if (!hideHyperlegibleFontSwitch)SettingsSwitch(
              ...
              if (!hideHideFingerDrawingToggleSwitch)
                SettingsSwitch(
              ...
              if (!hideDisableEraserAfterUseSwitch)
                SettingsSwitch(
              ...
              if (!hideAutoClearWhiteboardOnExitSwitch)
                SettingsSwitch(
              ...
              if (!hideEditorToolbarAlignmentSelection)
                SettingsSelection(
              ...
              if (!hideEditorToolbarShowInFullscreenSwitch)
                SettingsSwitch(
              ...
              if (!hideEditorPromptRenameSwitch)
                SettingsSwitch(
              ...
              if (!hidePrintPageIndicatorsSwitch)
                SettingsSwitch(
              ...
              if (!hideShapeRecognitionDelaySelection)
                SettingsSelection(
              ...
              if (!hideAutoStraightenLinesSwitch)
                SettingsSwitch(
              ...
              if (!hideAllowInsecureConnectionsSwitch)
                SettingsSwitch(
