...
class _StringsAppInfoEn {
	...
	// Translations
	String get licenseNotice => 'Saber  Copyright (C) 2023  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
...
class _StringsAppInfoZhHansCn extends _StringsAppInfoEn {
	...
	// Translations
	@override String get licenseNotice => 'Saber  版权所有 (C) 2023  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
	@override String get debug => 'DEBUG';
...
class _StringsAppInfoZhHantTw extends _StringsAppInfoEn {
	...
	// Translations
	@override String get licenseNotice => 'Saber  版權所有 (C) 2023  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
	@override String get debug => 'DEBUG';
...
extension on _StringsIt {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'appInfo.licenseNotice': return 'Sabre Copyright (C) 2023 Adil Hanney\nQuesto programma non ha alcuna garanzia. Questo è un software libero e sei libero di ridistribuirlo a determinate condizioni.';
			case 'appInfo.debug': return 'DEBUG';
...
extension on _StringsZhHansCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'appInfo.licenseNotice': return 'Saber  版权所有 (C) 2023  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
			case 'appInfo.debug': return 'DEBUG';
...
extension on _StringsZhHantTw {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'appInfo.licenseNotice': return 'Saber  版權所有 (C) 2023  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
			case 'appInfo.debug': return 'DEBUG';
