...
class RelicCatalog {
  static const RelicElement defaultSeal = RelicElement(
    id: 'seal_of_lucifer',
    name: 'Seal of Lucifer',
    assetPath: 'assets/relics/seal_lucifer.svg',
  );
  
  static const RelicElement standardSignature = RelicElement(
    id: 'sig_placeholder',
    name: 'Signee Placeholder',
    assetPath: 'assets/relics/sig_placeholder.svg',
  );

  static const RelicCollection essentialRunes = RelicCollection(
    id: 'essential_runes',
