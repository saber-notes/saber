...
class ProfessionalNotebookPack {
  ...
  static const _blankPage = PageTemplate(
    id: 'page_blank_white', name: 'Blank White',
    backgroundColor: Color(0xFFFFFFFF),
    description: 'Pure empty canvas.',
  );
  static const _ruledPage = PageTemplate(
  ...
  static const _dottedPage = PageTemplate(
  ...
  static const _gridPage = PageTemplate(
...
class HeritageNotebookPack {
  ...
  static const _vellumDotted = PageTemplate(
...
class InfernalNotebookPack {
  ...
  static const _darkPage = PageTemplate(
    id: 'page_dark_void', name: 'Dark Void',
    backgroundColor: Color(0xFF141414),
    description: 'Pure black canvas.',
  );
  static const _altarGrid = PageTemplate(
  ...
  static const _emberDots = PageTemplate(
...
class CyberNotebookPack {
  ...
  static const _terminalRuled = PageTemplate(
