...
void main() {
  test('Test that flutter submodule is up to date', () async {
    ...
    ///
    /// e.g. b06b8b2710
    final submoduleCommit = await shell
        .run('git rev-parse @:./submodules/flutter')
    ...
    final localFlutterVersion =
        await shell.run('flutter --version').then((value) => value.outText);
