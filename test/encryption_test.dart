...
void main() {
  group("Test encrypting and decrypting a filename", () {
    FlavorConfig.setup();
    Prefs.testingMode = true;
    Prefs.init();

    test('Logged in with a username', () async {
    ...
    test('Logged in with an email', () async {
      Prefs.username.value = "test.issue.118@orchid.anonaddy.com";
      Prefs.ncPassword.value = "test.issue.118";
      Prefs.encPassword.value = "test.issue.118";
      await _testEncryptDecrypt();
    });
...
Future _testEncryptDecrypt() async {
